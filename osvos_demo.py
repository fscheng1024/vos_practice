...
if train_model:
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:' + str(gpu_id)):
            ...
            trainer.train_finetune(dataset, parent_path, side_supervision, learning_rate, logs_path, max_training_iters,
...
with tf.Graph().as_default():
    with tf.device('/gpu:' + str(gpu_id)):
        ...
        trainer.test(dataset, checkpoint_path, result_path)
