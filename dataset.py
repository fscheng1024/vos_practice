...
class Dataset:
    def __init__(self, train_list, test_list, database_root, store_memory=True, data_aug=False):
        ...
        if not isinstance(train_list, list) and train_list is not None: # determine whether 'train_list' is list type
            ...
            if store_memory:
                ...
                if data_aug:
                    ...
                    for scale in data_aug_scales:
                        ...
                        img_sc = img.resize(img_size)       # img src
                        label_sc = label.resize(img_size)   # label src
        ...
        sys.stdout.write('\n')
        self.images_train_path = np.array(self.images_train_path) # turn list into array 
